...
menu1.url = "?menu=1"
menu1.tips = ["2.1 공통모듈구현","2.2 테스트케이스 작성","2.3 단위테스트","2.4 테스트 결과보고서"] //로그인 로그아웃 기능
menu2 = new Menu("3. 서버프로그램 구현")
menu2.url = "?menu=2"
menu2.tips = ["3.1 회원가입 구현","3.2 회원 로그인 구현","3.3 회원 로그아웃 구현","3.4 회원 리스트 출력 구현 "]
menu3 = new Menu("4. 배치프로그램구현")
menu3.url = "?menu=3"
menu3.tips = ["4.1 배치스케줄 구성","4.2 배치스케줄 테스트"]// (5분마다 프로그램 정상 작동유무 출력 메시지 스케줄링 확인)
